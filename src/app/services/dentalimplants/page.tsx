    ...
    <div className="bg-white rounded-[40px] p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 shadow-xl border border-slate-100">
      <div className="shrink-0 relative">
        <Link href="/doctors/dr-tanmay-sharma">
          <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-[#1E4D58] shadow-lg cursor-pointer hover:opacity-90 transition-opacity">
      ...
      <div>
        <h3 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">
          Meet Your Surgeon: <Link href="/doctors/dr-tanmay-sharma" className="hover:text-[#1E4D58] hover:underline underline-offset-4 decoration-[#1E4D58]">Dr. Tanmay Sharma</Link>
        </h3>
