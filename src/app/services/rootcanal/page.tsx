  ...
  <Section className="bg-white">
    <div className="bg-[#F8F9FA] rounded-[40px] p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 border border-slate-100 shadow-sm">
      ...
      <div className="shrink-0 relative flex gap-4 justify-center">
        ...
        <div className="relative group">
          <Link href="/doctors/dr-tanmay-sharma">
            <div className="w-32 h-40 md:w-40 md:h-48 rounded-2xl overflow-hidden border-4 border-white shadow-md transform -rotate-3 group-hover:rotate-0 transition-transform duration-300 bg-slate-200 cursor-pointer">
              <img
                src="/tan.jpeg"
                alt="Doctor 1"
          ...
          <div className="text-center mt-2">
            <Link href="/doctors/dr-tanmay-sharma" className="text-xs font-bold text-slate-700 uppercase tracking-wider hover:text-[#1E4D58]">Dr. Tanmay Sharma</Link>
          </div>
        </div>


        <div className="relative group mt-8 md:mt-8">
          <Link href="/doctors/dr-ridam-jain">
            <div className="w-32 h-40 md:w-40 md:h-48 rounded-2xl overflow-hidden border-4 border-white shadow-md transform rotate-3 group-hover:rotate-0 transition-transform duration-300 bg-slate-200 cursor-pointer">
              <img
                src="/ridam.jpeg"
                alt="Doctor 2"
          ...
          <div className="text-center mt-2">
            <Link href="/doctors/dr-ridam-jain" className="text-xs font-bold text-slate-700 uppercase tracking-wider hover:text-[#1E4D58]">Dr. Ridam Jain</Link>
          </div>
        </div>
